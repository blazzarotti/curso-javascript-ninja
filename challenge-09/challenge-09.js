...
var sub = calculator(100, 2);
var multi = calculator(30, 3);
var modu = calculator(10,3);
    ...
    */
    ...
    console.log(multi(function(number1, number2){
        return number1 * number2;
    }));
    ...
    console.log( 'O resultado da multiplicação é:' );
    console.log(modu(function(number1, number2){
        return number1 % number2;
    }));
